...
const (
	Conversation_CreateConversation_FullMethodName      = "/Conversation/CreateConversation"
	Conversation_GetSelfConversationList_FullMethodName = "/Conversation/GetSelfConversationList"
)
...
type ConversationClient interface {
	...
	GetSelfConversationList(ctx context.Context, in *GetSelfConversationListListReq, opts ...grpc.CallOption) (*GetSelfConversationListListResp, error)
}
...
func (c *conversationClient) GetSelfConversationList(ctx context.Context, in *GetSelfConversationListListReq, opts ...grpc.CallOption) (*GetSelfConversationListListResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetSelfConversationListListResp)
	err := c.cc.Invoke(ctx, Conversation_GetSelfConversationList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConversationServer interface {
	...
	GetSelfConversationList(context.Context, *GetSelfConversationListListReq) (*GetSelfConversationListListResp, error)
...
func (UnimplementedConversationServer) GetSelfConversationList(context.Context, *GetSelfConversationListListReq) (*GetSelfConversationListListResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSelfConversationList not implemented")
}
...
func _Conversation_GetSelfConversationList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSelfConversationListListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConversationServer).GetSelfConversationList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Conversation_GetSelfConversationList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConversationServer).GetSelfConversationList(ctx, req.(*GetSelfConversationListListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Conversation_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSelfConversationList",
			Handler:    _Conversation_GetSelfConversationList_Handler,
		},
	},
