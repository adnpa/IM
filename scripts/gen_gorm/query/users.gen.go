...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Salt = field.NewBytes(tableName, "salt")
	...
	_user.Memo = field.NewString(tableName, "memo")
