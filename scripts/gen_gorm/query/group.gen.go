...
func newGroup(db *gorm.DB, opts ...gen.DOOption) group {
	...
	_group.GroupID = field.NewInt64(tableName, "group_id")
	_group.GroupName = field.NewString(tableName, "group_name")
	_group.CreatorID = field.NewInt32(tableName, "creator_id")
	_group.AvatarURL = field.NewString(tableName, "avatar_url")
	_group.Description = field.NewString(tableName, "description")
	_group.MaxMembers = field.NewInt32(tableName, "max_members")
	_group.Status = field.NewInt32(tableName, "status")
...
type group struct {
	...
	ALL         field.Asterisk
	GroupID     field.Int64  // 群聊ID，主键，自增
	GroupName   field.String // 群聊名称
	CreatorID   field.Int32  // 创建者用户ID
	AvatarURL   field.String // 群聊头像URL
	Description field.String // 群聊描述
	MaxMembers  field.Int32  // 群聊最大成员数
	Status      field.Int32  // 群聊状态（0:正常，1:解散）
...
func (g *group) updateTableName(table string) *group {
	...
	g.CreatorID = field.NewInt32(table, "creator_id")
	g.AvatarURL = field.NewString(table, "avatar_url")
	g.Description = field.NewString(table, "description")
	g.MaxMembers = field.NewInt32(table, "max_members")
...
func (g *group) fillFieldMap() {
	...
	g.fieldMap["creator_id"] = g.CreatorID
	g.fieldMap["avatar_url"] = g.AvatarURL
	g.fieldMap["description"] = g.Description
	g.fieldMap["max_members"] = g.MaxMembers
