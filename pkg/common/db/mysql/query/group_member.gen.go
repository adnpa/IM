...
func newGroupMember(db *gorm.DB, opts ...gen.DOOption) groupMember {
	...
	_groupMember.UID = field.NewString(tableName, "uid")
	_groupMember.Nickname = field.NewString(tableName, "nickname")
	_groupMember.UserGroupFaceURL = field.NewString(tableName, "user_group_face_url")
	_groupMember.AdministratorLevel = field.NewInt32(tableName, "administrator_level")
...
type groupMember struct {
	...
	UserGroupFaceURL   field.String
	AdministratorLevel field.Int32
	JoinTime           field.Time
...
func (g *groupMember) updateTableName(table string) *groupMember {
	...
	g.UserGroupFaceURL = field.NewString(table, "user_group_face_url")
	g.AdministratorLevel = field.NewInt32(table, "administrator_level")
...
func (g *groupMember) fillFieldMap() {
	...
	g.fieldMap["user_group_face_url"] = g.UserGroupFaceURL
	g.fieldMap["administrator_level"] = g.AdministratorLevel
